...
describe('CartServiceService', () => {
  ...
  it('getUserIdByEmail()', () => {
    ...
    const req = httpController.expectOne(
      'https://localhost:44310/Cart/get-user-ID/' + inputData.email
    );
  ...
  it('getUserIdByEmail() fail', () => {
    ...
    //check expected URL
    const req = httpController.expectOne(
      'https://localhost:44310/Cart/get-user-ID/test@test.com'
    );
  ...
  it('getCart()', () => {
    ...
    //check Expected URL
    const req = httpController.expectOne(
      'https://localhost:44310/Cart/GetCartById/' + inputData.cartID
    );
    //check expected http request method
    expect(req.request.method).toEqual('GET');
  ...
  it('modifyQty()', () => {
    ...
    // Check expected URL
    const req = httpController.expectOne(
      'https://localhost:44310/Cart/set-order-qty/' +
        inputData.orderID +
        '/' +
        inputData.Qty
    );
  ...
  it('removeOrder()', () => {
    ...
    //check expected URL
    const req = httpController.expectOne(
      'https://localhost:44310/Cart/remove-order/' + inputData.orderID
    );
  ...
  it('emptyCart', () => {
    ...
    // Check expected URL
    const req = httpController.expectOne('https://localhost:44310/Cart/emptycart/' + inputData.orderID);
