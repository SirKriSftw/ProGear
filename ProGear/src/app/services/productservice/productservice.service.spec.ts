...
describe('ProductserviceService', () => {
  ...
  it('getAllProducts()', () => {
    ...
    // Check expected URL
    const req = httpController.expectOne('https://localhost:5001/api/ProductList/List_of_Products');
  ...
  it('getProductsByID()', () => {
    ...
    // Check expected URL
    const req = httpController.expectOne('https://localhost:5001/api/ProductList/getCat/'+ inputData.catID);
  ...
  it('getProductsSearch()', () => {
    ...
    // Check expected URL
    const req = httpController.expectOne('https://localhost:5001/api/ProductList/search/'+ inputData.type);
    // Check expected HTTP Request method
    expect(req.request.method).toEqual('GET');
